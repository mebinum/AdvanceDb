<%@ Page Language="C#" AutoEventWireup="True" Inherits="Sitecore.SharedSource.SearchDemo.DemoPage3"
   CodeBehind="DemoPage3.aspx.cs" MasterPageFile="~/sitecore modules/Web/SearchDemo/Demo.Master" %>

<asp:Content ContentPlaceHolderID="header" runat="server">
   <h2>
      Scenario 3. Multi field search
   </h2>
   <p>
