<%@ Page Language="C#" AutoEventWireup="True" Inherits="Sitecore.SharedSource.SearchDemo.DemoPage5"
   CodeBehind="DemoPage5.aspx.cs" MasterPageFile="~/sitecore modules/Web/SearchDemo/Demo.Master" %>

<asp:Content ContentPlaceHolderID="header" runat="server">
   <h2>
      Scenario 5. Date Range Search
   </h2>
   <p>
