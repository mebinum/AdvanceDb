<%@ Page Language="C#" AutoEventWireup="True" Inherits="Sitecore.SharedSource.SearchDemo.DemoPage4"
   CodeBehind="DemoPage4.aspx.cs" MasterPageFile="~/sitecore modules/Web/SearchDemo/Demo.Master" %>

   <asp:Content ContentPlaceHolderID="header" runat="server">
   <h2>
      Scenario 4. Numeric Range Search
   </h2>
   <p>
